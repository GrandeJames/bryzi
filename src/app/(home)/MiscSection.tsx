...
function MiscSection({ miscTasks }: { miscTasks: any[] }) {
  return (
    <section className="col-span-4">
      <header className="font-semibold text-xl mb-2 text-gray-300">Miscellaneous</header>
...
function MiscTask({ task }: { task: Task }) {
  return (
    <div className="grid grid-cols-4 py-3 px-5 bg bg-neutral-900/70 rounded-xl">
