  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-orange-400 text-neutral-50 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-orange-400 focus:text-neutral-50 dark:bg-orange-400 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-orange-400 dark:focus:text-neutral-900",
